...
class RollCostIntegralAutopilot(Node):
    ...
    def __init__(self):
        ...
        self._log_file.write(
            ...
            'yaw_deg,yaw_to_wp_deg,yaw_ref_deg,yaw_err_deg,'
            'speed_ref,speed_meas,'
            'roll_deg,roll_rms_window_deg,roll_rms_total_deg,'
            'pitch_deg,pitch_rms_window_deg,pitch_rms_total_deg,'
            'J_candidate,J_goal,J_wave,J_progress,J_smooth,'
            'J_total,J_roll,J_pitch,J_roll_rate,J_pitch_rate,J_goal_heading,J_no_progress,J_control,'
            'I_roll,I_pitch,I_roll_rate,I_pitch_rate,I_control,tl,tr\n'
        )
    ...
    def _log(self, now, dist, yaw_to_wp, yaw_ref, yaw_err, speed_ref, cost):
        ...
        self._log_file.write(
            ...
            f'{math.degrees(self.yaw):.2f},{math.degrees(yaw_to_wp):.2f},'
            f'{math.degrees(yaw_ref):.2f},{math.degrees(yaw_err):.2f},'
            f'{speed_ref:.3f},{self.speed_meas:.3f},'
            ...
            f'{cost["J"]:.5f},{cost["goal"]:.5f},{cost["wave"]:.5f},'
            f'{cost["progress"]:.5f},{cost["smooth"]:.5f},'
            ...
            f'{self._last_tl:.2f},{self._last_tr:.2f}\n'
        )
